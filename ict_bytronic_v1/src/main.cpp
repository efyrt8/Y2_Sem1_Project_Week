...
// SORTING
const int METAL_PEG_DETECT = CONTROLLINO_A0; // 0 = No metal, 1 = metal
const int SORT_AREA_DETECT = CONTROLLINO_A1; // 0 = Empty, 1 = Object Detected
const int SORT_SOLENOID_RETURN = CONTROLLINO_A9; // 0 = Eject, 1 = Extract

// HOOPER DETECT
const int ASSEMBLY_HOPPER_FULL = CONTROLLINO_A2; // 0 = Detect object, 1 = No object detected

// ASSEMBLY DETECT POINT
const int RING_ASSEMBLY = CONTROLLINO_A3; // 0 = Assembled, 1 = Else
const int ASSEMBLY_DETECT = CONTROLLINO_A4; // 0 = Nothing, 1 = Detect object
const int BELT_PEG_DETECT = CONTROLLINO_A8; // 1 = Nothing, 0 = Detect object

// LATCH SWITCH
const int ON_SWITCH = CONTROLLINO_A6; // 0 = Not push, 1 = Push
const int OFF_SWITCH = CONTROLLINO_A7; // 0 = Push, 1 = Not Push

// REJECT POINT
const int REJECT_AREA_DETECT = CONTROLLINO_A5; // 0 = Nothing, 1 = Object Detected
const int REJECT_SOLENOID_RETURN = CONTROLLINO_IN0; // 0 = Eject, 1 = Extract

// BELT
const int CHAIN_CONVEYOR = CONTROLLINO_D0;
const int BELT_CONVEYOR = CONTROLLINO_D4;

// SORTING
const int SORT_SOLENOID = CONTROLLINO_D1;

// HOOPER REJECT
const int ROTARY_SOLENOID = CONTROLLINO_D2;

// NON-ASSEMBLY REJECT
const int REJECT_SOLENOID = CONTROLLINO_D3;

// ROBOT ARM SIGNAL
const int robot_arm_signal = CONTROLLINO_D5;
...
void reject_object(){
  ...
  if (reject_solenoid_active && (millis() - current_solenoid_time >= reject_solenoid_reset)){
    digitalWrite(REJECT_SOLENOID, LOW);
